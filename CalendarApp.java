...
public class CalendarApp extends JFrame implements ActionListener {
   ...
   private void setupPanel() {
        ...
        textField1.setFont(new Font("Monospaced", Font.BOLD, 20));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btn1) {
			...
			printAttributes.add(new PrinterResolution(300, 300, PrinterResolution.DPI));
			printAttributes.add(new MediaPrintableArea(10, 25, 210 - 20, 297 - 50, MediaPrintableArea.MM));
			
			printAttributes.add(new JobName("Calendar " + calendar.getYear(), Locale.ENGLISH));
            
            JTextArea textArea2 = new JTextArea();
            textArea2.setFont(new Font("Monospaced", Font.BOLD, 10));
